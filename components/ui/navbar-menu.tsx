  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer text-foreground hover:opacity-[0.9] px-3 py-2"
      >
        {item}
      </motion.p>
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 z-50">
              {/* This invisible element creates a bridge between the menu item and dropdown */}
              <div className="h-[1.2rem] w-full" />
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className={`relative rounded-full flex justify-center space-x-2 ${className || ''}`}
    >
      {children}
    </nav>
  );
